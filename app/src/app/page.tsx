...
const CreateGateForm = ({
  ...
  return (
    <>
      {selectedGateType === GateType.EVENTS_EMITTED && (
        <>
          <div>
          ...
          <div className="flex items-center">
            ...
            <div className="pr-2">
              <Input
                ...
                onChange={(e) => setEvaluationPeriod(parseInt(e.target.value))}
              />
            </div>
            <Dropdown
                ...
                const gateId = await createGate(
                  {
                    gate: {
                      ...
                      gateConfiguration: {
                        ...
                        event: selectedEvent ? selectedEvent.name : "undefined",
                        addressArgument: {
      ...
      {selectedGateType === GateType.READ_CONTRACT_INFO && (
        <>
          <div>
            <Text variant={"regular"} weight={"bold"}>
          ...
          <div className="pt-[10px] pb-[10px]">
            ...
            <div className="pt-[10px] pb-[10px]">
              <Text variant={"small"} color={"tertiary"}>
                This is only necessary if the function to check staking amounts
                for returns a multiple fields
              </Text>
            </div>
            <Input
              className={
    ...
    return (
      <>
        <div className={"rounded-brand bg-white p-8 sm:w-[868px]"}>
          ...
          <CreateGateForm
            selectedGateType={selectedGate.type}
            onCreateComplete={(gateId: number) => {
